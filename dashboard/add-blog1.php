...
if($status=="OK")
{
$qf=mysqli_query($con,"INSERT INTO blog1 (blog_title, blog_desc) VALUES ('$blog_title', '$blog_desc')");
...
if($_SERVER['REQUEST_METHOD'] == 'POST')
   ...
   ?>
              <form action="" method="post" enctype="multipart/form-data">
                                              ...
                                              <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="firstnameInput" class="form-label">FAQ  Tax dematerialization Title</label>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="firstnameInput" class="form-label">Short FAQ  Tax dematerialization  Description</label>
