...
<div class="main-content">
 <div class="page-content">
       <div class="container-fluid">
                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Director of the information systems</a></li>
                    ...
                    <!-- end page title -->
                    <?php
					 $query="SELECT * FROM  sol1 where id='$todo' ";
...
if($status=="OK")
{
$qb=mysqli_query($con,"update sol1 set blog_title='$blog_title', blog_desc='$blog_desc' where id='$todo'");
